...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to 5TygaEats.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 5TygaEats, accessible from{' '}
            <a
              href='https://royalcradle-shop.onrender.com/'
      ...
      <ul>
        <li>
          <p>By email: 5tygaeats@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 0658928881</p>
        </li>
      </ul>
    </>
  );
