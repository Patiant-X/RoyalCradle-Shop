...
const RestaurantItemEditScreen = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (
      ...
      try {
        ...
        refetch();
        navigate(`/admin/restaurantitemslist/${product?.user}`);
      } catch (err) {
  ...
  const uploadFileHandler = async (e) => {
    ...
    formData.append('restaurantName', formattedRestaurantName);
    try {
  ...
  return (
    <>
      <Link
        to={`/admin/restaurantitemslist/${product?.user}`}
...
export default RestaurantItemEditScreen;
